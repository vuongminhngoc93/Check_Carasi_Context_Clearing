...
namespace Check_carasi_DF_ContextClearing
{
    class CarasiCLI
    {
        ...
        static void ShowHelp()
        {
            ...
            Console.WriteLine("  CarasiCLI.exe [options] [path]");
            Console.WriteLine();
            ...
            Console.WriteLine("  CarasiCLI.exe");
            Console.WriteLine("  CarasiCLI.exe Input");
            Console.WriteLine("  CarasiCLI.exe -path Input -search *.xlsx");
            Console.WriteLine("  CarasiCLI.exe -path C:\\Data -search *carasi* -recursive");
            Console.WriteLine();
        }
        ...
        static void ProcessCarasiFile(string filePath)
        {
            ...
            try
            {
                ...
                Console.WriteLine("    Validating interface compatibility...");
            }
            catch (Exception ex)
            {
        ...
        static void ProcessA2LFile(string filePath)
        {
            try
            {
                ...
                Console.WriteLine("    Extracting signal definitions...");
            }
            catch (Exception ex)
            {
                throw new Exception($"A2L processing failed: {ex.Message}");
            }
        }
        ...
        static void ProcessExcelFile(string filePath)
        {
            try
            {
                ...
                Console.WriteLine("    Checking data format and consistency...");
            }
            catch (Exception ex)
            {
                throw new Exception($"Excel processing failed: {ex.Message}");
            }
        }
        ...
        static void ProcessGenericFile(string filePath)
        {
            ...
            {
                Console.WriteLine("    Warning: Large file detected");
            }
